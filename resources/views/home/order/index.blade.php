                         ...
                         <div class="row">
                            <div class="col-sm-6">
                               <div class="tp-order-details-item">
                                  <h4>Order Date:</h4>
                                  <p>{{ date('l, F Y', strtotime($order[0]->created_at))  }}</p>
                               </div>
                            </div>
                            <div class="col-sm-6">
                               <div class="tp-order-details-item">
                      ...
                      <div class="tp-order-info-list">
                         <ul>
                            ...
                            <li class="tp-order-info-list-desc">
                                <p><span>{{ $ord->produk->nama }} x {{ $ord->jumlah }}</span></p>
                                <span>{{ $ord->produk->harga }}</span>
                             </li>
                            @endforeach
                            ...
                            <li class="tp-order-info-list-subtotal">
                               <span>Subtotal</span>
                               <span>@currency($order[0]->subtotal)</span>
                            </li>
                         ...
                         <li class="tp-order-info-list-shipping">
                            ...
                            <div class="tp-order-info-list-shipping-item d-flex flex-column align-items-end">
                                <span>@currency($order[0]->ongkoskirim)</span>
                            </div>
                         </li>
                            ...
                            <li class="tp-order-info-list-total">
                               <span>Total</span>
                               <span>@currency($order[0]->total)</span>
                            </li>
                         </ul>
                      </div>
                   </div>
