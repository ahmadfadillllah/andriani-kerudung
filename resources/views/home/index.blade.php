...
<main>
                                        ...
                                        <div class="tp-product-item p-relative transition-3 mb-25">
                                            <div class="tp-product-thumb p-relative fix m-img">
                                                ...
                                                <div class="tp-product-action">
                                                    <div class="tp-product-action-item d-flex flex-column">
                                                        <form action="{{ route('home.cart.add_luar', $p->id) }}" method="post">
                                                            @csrf
                                                            <button type="submit"
                                                            ...
                                                            <span class="tp-product-tooltip">Tambah ke keranjang</span>
                                                        </button>
                                                        </form>
                                                        <button type="button"
                                                            class="tp-product-action-btn tp-product-quick-view-btn"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#producQuickViewModal{{ $p->id }}">
                                            ...
                                            <div class="tp-product-content">
                                                <div class="tp-product-category">
                                                    <a href="javascript:void(0);">{{ $p->jenisproduk->nama }}</a>
                                                </div>
                                                ...
                                                <div class="tp-product-price-wrapper">
                                                    ...
                                                    <span class="tp-product-price new-price">@currency($p->harga)</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="modal fade tp-product-modal" id="producQuickViewModal{{ $pp->id }}" tabindex="-1"
        aria-labelledby="producQuickViewModal{{ $pp->id }}" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="tp-product-modal-content d-lg-flex align-items-start">
                    <button type="button" class="tp-product-modal-close-btn" data-bs-toggle="modal"
                        data-bs-target="#producQuickViewModal{{ $pp->id }}"><i class="fa-regular fa-xmark"></i></button>
                    <div class="tp-product-details-thumb-wrapper tp-tab d-sm-flex">
                        ...
                        <div class="tab-content m-img" id="productDetailsNavContent{{ $pp->id }}">
                    ...
                    <div class="tp-product-details-wrapper">
                        <div class="tp-product-details-category">
                            <span>{{ $pp->jenisproduk->nama }}</span>
                        </div>
                        <h3 class="tp-product-details-title">{{ $pp->nama }}</h3>
                        ...
                        <div class="tp-product-details-price-wrapper mb-20">
                            ...
                            <span class="tp-product-details-price new-price">@currency($pp->harga)</span>
                        </div>
                        ...
                        <!-- actions -->
                        <form action="{{ route('home.cart.add', $pp->id) }}" method="post">
                            @csrf
                                ...
                                <div class="tp-product-details-action-item-wrapper d-sm-flex align-items-center">
                                    <div class="tp-product-details-quantity">
                                        <div class="tp-product-quantity mb-15 mr-15">
                                            ...
                                            <input class="tp-cart-input" type="text" value="1"  name="jumlah"/>
                                    ...
                                    <div class="tp-product-details-add-to-cart mb-15 w-100">
                                        <button type="submit" class="tp-product-details-add-to-cart-btn w-100">Tambah ke keranjang</button>
                                    </div>
                                </div>
