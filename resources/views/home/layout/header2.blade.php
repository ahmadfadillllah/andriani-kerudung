                    ...
                    <div class="col-xl-4 col-lg-3 col-md-8 col-6">
                        <div class="tp-header-main-right d-flex align-items-center justify-content-end">
                            <div class="tp-header-login d-none d-lg-block">
                                @if (Auth::user())
                                <a href="{{ route('home.profile.index') }}" class="d-flex align-items-center">
                                    ...
                                    <div class="tp-header-login-content d-none d-xl-block">
                                        ...
                                        <h5 class="tp-header-login-title">Selamat berbelanja!</h5>
                                    </div>
                                </a>
                                @else
                                <a href="{{ route('login') }}" class="d-flex align-items-center">
                                    ...
                                    <div class="tp-header-login-content d-none d-xl-block">
                                        <span>Hello, Masuk</span>
                                        <h5 class="tp-header-login-title">di Akun Kamu!</h5>
                                    </div>
                                </a>
                            ...
                            <div class="tp-header-action d-flex align-items-center ml-50">
                               ...
                               @if (Auth::user())
                                @if (request()->routeIs('home.index') or request()->routeIs('home.profile.index') or request()->routeIs('home.cart.index'))
                                    <div class="tp-header-action-item">
                                        <button type="button" class="tp-header-action-btn cartmini-open-btn">
                                            ...
                                            <span class="tp-header-action-badge">{{ $cek_cart }}</span>
                                        </button>
                                    </div>
                                @endif
                               @endif
