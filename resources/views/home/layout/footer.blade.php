    ...
    <!-- JS here -->
    <script src="{{ asset('shofy/html.weblearnbd.net/shofy-prv/shofy') }}/assets/js/vendor/jquery.js"></script>
    <script src="{{ asset('shofy/html.weblearnbd.net/shofy-prv/shofy') }}/assets/js/vendor/waypoints.js"></script>
    <script src="{{ asset('shofy/html.weblearnbd.net/shofy-prv/shofy') }}/assets/js/bootstrap-bundle.js"></script>
    <script src="{{ asset('shofy/html.weblearnbd.net/shofy-prv/shofy') }}/assets/js/meanmenu.js"></script>
    <script src="{{ asset('shofy/html.weblearnbd.net/shofy-prv/shofy') }}/assets/js/swiper-bundle.js"></script>
    <script src="{{ asset('shofy/html.weblearnbd.net/shofy-prv/shofy') }}/assets/js/slick.js"></script>
    <script src="{{ asset('shofy/html.weblearnbd.net/shofy-prv/shofy') }}/assets/js/range-slider.js"></script>
    <script src="{{ asset('shofy/html.weblearnbd.net/shofy-prv/shofy') }}/assets/js/magnific-popup.js"></script>
    <script src="{{ asset('shofy/html.weblearnbd.net/shofy-prv/shofy') }}/assets/js/nice-select.js"></script>
    <script src="{{ asset('shofy/html.weblearnbd.net/shofy-prv/shofy') }}/assets/js/purecounter.js"></script>
    <script src="{{ asset('shofy/html.weblearnbd.net/shofy-prv/shofy') }}/assets/js/countdown.js"></script>
    <script src="{{ asset('shofy/html.weblearnbd.net/shofy-prv/shofy') }}/assets/js/wow.js"></script>
    <script src="{{ asset('shofy/html.weblearnbd.net/shofy-prv/shofy') }}/assets/js/isotope-pkgd.js"></script>
    <script src="{{ asset('shofy/html.weblearnbd.net/shofy-prv/shofy') }}/assets/js/imagesloaded-pkgd.js"></script>
    <script src="{{ asset('shofy/html.weblearnbd.net/shofy-prv/shofy') }}/assets/js/ajax-form.js"></script>
    <script src="{{ asset('shofy/html.weblearnbd.net/shofy-prv/shofy') }}/assets/js/main.js"></script>
</body>
