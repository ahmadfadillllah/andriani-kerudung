                                   ...
                                   <div class="col-md-6">
                                      <div class="profile__main-inner d-flex flex-wrap align-items-center">
                                         ...
                                         <div class="profile__main-content">
                                            ...
                                            <p>Kamu mempunyai <span>....</span> orderan</p>
                                         </div>
                                      </div>
                                   </div>
                                   <div class="col-md-6">
                                      ...
                                      <div class="col-xxl-12">
                                         <div class="profile__input-box">
                                            <div class="profile__input">
                                                ...
                                                <textarea placeholder="Enter your bio" readonly>Akun anda bukan VIP,, silahkan Upgrade untuk mendapatkan potongan harga</textarea>
                                                @else
                                                <textarea placeholder="Enter your bio" readonly>Yaay!!! akun anda VIP, Silahkan gunakan promo menarik</textarea>
                                                @endif
                                            </div>
                                         </div>
                                      </div>
                             ...
                             <div class="row">
                                <div class="col-xxl-12">
                                    <div class="profile__btn">
                                       ...
                                       <button type="button" class="tp-btn" style="float: right"  data-bs-toggle="modal" data-bs-target="#tambahAlamat">Tambah Alamat</button>
                                    </div>
                                 </div>
                                <div class="col-md-12">
                                   <div class="profile__address-item d-sm-flex align-items-start">
                                      ...
                                      <div class="profile__address-content">
                                         <h3 class="profile__address-title">Detail Alamat</h3>
                                         <p><span>Provinsi :</span>3576 Glen Street</p>
                                         <p><span>Kota/Kabupaten:</span>Summer Shade</p>
                                         <p><span>Kecamatan:</span>Kentucky</p>
                                         <p><span>Kelurahan:</span>270-428-8378</p>
                                         <p><span>Alamat Lengkap:</span>42166</p>
                                      </div>
                                   </div>
                                </div>
